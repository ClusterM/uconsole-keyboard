...
**This branch contains my own layout and experiments.**
...
- **Keyboard backlight dimming after inactivity** - The keyboard backlight brightness automatically decreases after a period of inactivity (configurable in `config.h`)
- **Trackball acceleration** - improved trackball speed and acceleration (configurable in `config.h`)
